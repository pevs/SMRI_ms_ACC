...
### Update symbols from original analysis
### Zhao, et al. Mol Psych 2015
### Alexis Norris
### Created: 2019-01-02
### Modified: 2019-01-06
...
# Input files --------------------------------------------------
### Original ACC results
#degs <- read_tsv("input/genesets/Zhao_ACC/Zhao_ACC_TableS4.txt")
...
### Parameters
analysis_name <- "anno_Zhao_ACC"


# Load Zhao DEGs -----------------------------------------------
### Source: TableS4 from Zhao, et al. Mol Psych 2015 paper
### DEGS (FDR < 0.25) for SZ and BP 
degs <- read_tsv("input/genesets/Zhao_ACC/Zhao_ACC_TableS4.txt")

### Uniform nomenclature
names(degs) <- recode(names(degs), "Gene" = "gene_symbol")
...
df_hgnc %>%
  ...
  write_csv("input/genesets/Zhao_ACC/Zhao_ACC_TableS4_genes_removed.csv")
df_hgnc <- df_hgnc %>%
  filter(!(gene_symbol_corrected_reason %in% reasons))

### Write out
write_tsv(df_hgnc, "input/genesets/Zhao_ACC/Zhao_ACC_TableS4_gene_symbols.tsv")
df_hgnc %>%
  ...
  write_tsv("input/genesets/Zhao_ACC/Zhao_ACC_TableS4_gene_symbols_updateStats.tsv")
